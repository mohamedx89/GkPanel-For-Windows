...
<html>
    ...
    <body>
        <a class="header_logo" href="http://www.cybercore.tv/" target="_blank">
            <img src="data:image/png;
                 ...
                 width="263" height="70" alt="HuyGK - The private-source web hosting control panel." border="0"></a>
        <div class="content">
            <h1><?php echo strtolower($_SERVER['HTTP_HOST']); ?></h1>
            <p>This domain is registered and is currently parked.... </p>
            <p>Thank you for using GKPanel to manage your hosting!</p>
            <p><b>For more information and help using GKPanel please visit:</b> <a href="http://www.cybercore.tv/" target="_blank">www.cybercore.tv</a>.</p>
            <p>Kind regards,<br>
                Your hosting company.</p>
        </div>
        <div class="poweredbox">
            <p><strong>Powered by <a href="https://www.facebook.com/huyxgk/" target="_blank">HuyGK</a></strong> - The private-source web hosting control panel.</p>
        </div>
    </body>
</html>
