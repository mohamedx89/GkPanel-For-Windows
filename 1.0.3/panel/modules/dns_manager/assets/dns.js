...
var GKPanelDNS = {
    ...
    init: function() {
        ...
        GKPanelDNS.cache.dnsTitleId = $("#dnsTitle");

        GKPanelDNS.events.init();
    ...
    events: {
        ...
        promptBeforeClose: function(e) {
            ...
            if (!GKPanelDNS.unsavedChanges) return;
        ...
        init: function() {
            ...
            $(document).on('change','div.hostName > input',function() {
                GKPanel.utils.log('hostname change fired');
                var hostnameSelector = $(this);
            ...
            $(document).on("keydown", "#dnsRecords input", function() {
                ...
                GKPanel.utils.log(GKPanelDNS.cache.dnsTitleId);
                GKPanel.utils.log($("#dnsTitle"));
                //$("#dnsTitle").find(".save, .undo").removeClass("disabled");
                GKPanelDNS.cache.dnsTitleId.find(".save, .undo").removeClass("disabled");
            ...
            $("#dnsRecords div.add > .btn").click(function(e) {
                GKPanel.utils.log('add record button clicked');
                GKPanelDNS.records.addRow($(this));
                e.preventDefault();
            });

            // Mark Record as "Deleted" and change the view of it's Row to reflect a Deleted item
            $(document).on("click", ".delete", function(e) {
                GKPanelDNS.records.deleteRow($(this));
                e.preventDefault();
            });
            ...
            $(document).on("keydown", "div.dnsRecord input[type='text']", function() {
                ...
                GKPanelDNS.unsavedChanges = true;
            });

            // Undo editing of an EXISTING ROW
            $("button.undo").on("click", function() {
                GKPanelDNS.records.undoRow($(this));
            });
            ...
            $("#dnsTitle a.undo").click(function() {
                ...
                GKPanelDNS.unsavedChanges = false;
                return false;
            });
    ...
    records: {
        ...
        addRow: function(record) {
            ...
            if (record.parents("div.add").siblings().length > 2) {
                GKPanel.utils.log('div .add sibblings...');
                GKPanel.utils.log(record.parents("div.add").siblings());
