...
class module_controller extends ctrl_module
{
    ...
    static function ExecuteCreateUser($uid, $username, $database, $access)
    {
        ...
        // Add database to GKPanel user account...
    ...
    static function getMysqlUsagepChart()
    {
        ...
        $used = $mysql;
        $free = $total - $used;
        $line .= "<img src=\"etc/lib/pChart2/GKPanel/z3DPie.php?score=" . $free . "::" . $used . "&labels=Free: " . $free . "::Used: " . $used . "&legendfont=verdana&legendfontsize=8&imagesize=240::190&chartsize=120::90&radius=100&legendsize=150::160\"/>";
        return $line;
    }
