...
function ExecuteBackup($userid, $username, $download = 0) {
    ...
    if (!is_dir(ctrl_options::GetSystemOption('gkpanel_root') . "etc/tmp/")) {
        fs_director::CreateDirectory(ctrl_options::GetSystemOption('gkpanel_root') . "etc/tmp/");
    }
    $temp_dir = ctrl_options::GetSystemOption('gkpanel_root') . "etc/tmp/";
    ...
    } else {//cd /var/GKPanel/hostdata/zadmin/; zip -r backups/backup.zip public_html/
