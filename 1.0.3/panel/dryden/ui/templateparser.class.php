...
class ui_templateparser
{
    ...
    /**
     * Array of all the functions allowed by XPanelX Template system with the pattern to identify them
     * @author HuyGK (huygk@cybercore.tv)
     */
    ...
    /**
     * Compiles XPanelX loop template tags into valid PHP
     * @author HuyGK (huygk@cybercore.tv)
     */
    ...
    /**
     * Compiles XPanelX echo loop template tags into valid PHP
     * @author HuyGK (huygk@cybercore.tv)
     */
    ...
    /**
     * Compiles XPanelX end loop template tags into valid PHP
     * @author HuyGK (huygk@cybercore.tv)
     */
    ...
    /**
     * Compiles XPanelX if template tags into valid PHP
     * @author HuyGK (huygk@cybercore.tv)
     */
    ...
    /**
     * Compiles XPanelX end if template tags into valid PHP
     * @author HuyGK (huygk@cybercore.tv)
     */
    ...
    /**
     * Compiles XPanelX lanuage template tags into valid PHP
     * @author HuyGK (huygk@cybercore.tv)
     */
    ...
    /**
     * Compiles XPanelX function each template tags into valid PHP
     * @author HuyGK (huygk@cybercore.tv)
     */
    ...
    /**
     * Compiles XPanelX template class tag into valid PHP
     * @author HuyGK (huygk@cybercore.tv)
     */
    ...
    {
        self::$storageLocation = ctrl_options::GetSystemOption('gkpanel_root') . self::$storageLocation;
    }
    ...
    /**
     * All br tags to be used using the GKPanel br tag loader
     * @author HuyGK (huygk@cybercore.tv)
     */
