 ...
 *
 * Provides bcrypt (Blowfish single-way encryption) functionality for password hashing in GKPanel.
 * @package XPanelx
...
class runtime_hash {
    ...
    public function Crypt() {
        require_once ctrl_options::GetSystemOption('gkpanel_root') . 'cnf/security.php';
        global $security;
