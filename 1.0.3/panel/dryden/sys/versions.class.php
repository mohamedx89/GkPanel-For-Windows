 ...
 *
 * This reports on core GKPanel software versions.
 * @package XPanelx
...
class sys_versions {
    ...
    static function ShowOSName() {
        ...
        if (!empty($osname)) {
             ...
             */
            /*
              $list = @parse_ini_file("lib/GKPanel/os.ini", true);
    ...
    /**
     * Returns the GKPanel version (based on the DB version number.)
     * @author HuyGK (huygk@cybercore.tv)
     * @return string GKPanel DB Version
     */
    static function ShowGKPanelVersion() {
