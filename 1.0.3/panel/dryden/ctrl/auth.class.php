 ...
 *
 * Authentication class handles GKPanel authentication and handles user sessions.
 * @package XPanelx
...
class ctrl_auth
{
     ...
     * @author HuyGK (huygk@cybercore.tv)
     * @param int $zpuid The GKPanel user account ID to set the session as.
     * @return bool
     */
    ...
    /**
     * Destroys a session and ends a user's GKPanel session.
     * @author HuyGK (huygk@cybercore.tv)
     * @return bool
     */
     ...
     * @author HuyGK (huygk@cybercore.tv)
     * @global obj $controller The GKPanel controller object.
