 ...
 *
 * Options class communicates with the GKPanel database and can read and write system options.
 * @package XPanelx
...
class ctrl_options {
     ...
     * @param string $name The name of the system option (eg. gkpanel_root)
    ...
    /**
     * An alias of 'GetSystemOption' to 'fix' the recent refactor of the GKPanel Code, this was affecting third-party modules which relied on this old function name.
     * @author HuyGK <huygk@cybercore.tv>
