...
class ctrl_users {
     ...
     * @param int $uid The GKPanel user account ID.
     * @return array
     */
    ...
    /**
     * @todo Does this still need to be here as this is now managed under a module and not seen as 'core' but template still relies on this at present! - HuyGK
     */
