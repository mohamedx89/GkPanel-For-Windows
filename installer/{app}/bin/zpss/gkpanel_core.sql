...
CREATE DATABASE `gkpanel_core` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
...
VALUES
    ...
    1,
    0,
    'Welcome to your new GKPanel installation! You can remove this message from the Client Notice Manager module. This module allows you to notify your clients of service outages, upgrades and new features etc :-)',
    NULL,
    0,
    NULL
    );
...
CREATE TABLE IF NOT EXISTS `gkpanel_core`.`x_dns_create` (
...
INSERT INTO `gkpanel_core`.`x_dns_create` (`dc_id_pk`, `dc_acc_fk`, `dc_type_vc`, `dc_host_vc`, `dc_ttl_in`, `dc_target_vc`, `dc_priority_in`, `dc_weight_in`, `dc_port_in`) VALUES
...
(2,1,'How do I change my password?','Your GKPanel and MySQL password can be easily changed using the &quot;Change Password&quot; icon on the control panel.',1,NULL,NULL),
(3,1,'I don&#39;t think one of the services(Apache, MySQL, FTP, etc) are running. Is there any easy way to check?','GKPanel comes with a service monitoring system that checks to make sure all the services are up and running, Simply go to your Control Panel Home and select the module called &quot;Service Status&quot;. From there you will be able to see if any of the services are down or up.',1,NULL,NULL),
(4,1,'How can I set my domain to work with my GKPanel Account?','To setup up a domain with GKPanel first thing you need to do is go &quot;Domains&quot; and add your to the list. Next you need to set the Name Server on your Domain Registrar to match that of your host. This information can be obtained by contacting your host.',1,NULL,NULL),
...
(11,1,'How do I create an E-Mail Account?','Go to the Mail section of GKPanel and select the module called &quot;Mailboxes&quot;, from here you can create E-Mail account for each domain setup on your account. You can also reset passwords to previously created accounts.',1,NULL,NULL),
(12,1,'How do I create a Mail Alias?','Go to the Mail section of GKPanel and select the module called &quot;Aliases&quot;, from here you can create Alias E-Mail accounts for each previously created E-Mail account. All mail sent to the alias will be delivered to the master e-mail account.',1,NULL,NULL),
(13,1,'How can I create a Mailing List?','Mailing lists can be setup by going to the Mail section of GKPanel and select the module called &quot;Distribution Lists&quot;, from here you can create Mailing lists by creating an E-mail Account. ',1,NULL,NULL),
(14,1,'How do I use Mail Forwards?','Go to the Mail section of GKPanel and select the module called &quot;Forwards&quot;, from here you can create E-Mail address on your domains that will forward to other E-Mail addresses that are on different servers like &quot;G-Mail, Yahoo, and MSN&quot;. ',1,NULL,NULL),
...
(16,1,'How can I view how much Data I have used?','You can view how much data you have used by accessing the &quot;Usage Viewer&quot; under the Account Information section of GKPanel. It displays account information in different formats. It displays Data Usage, Domain Usage, Bandwidth Usage, MySQL Usage, and much more.',1,NULL,NULL),
(17,1,'How can I access Webmail?','Go to the Mail section of GKPanel and select the module called &quot;Webmail&quot;, from here you can login to your E-Mail account and view and create messages. ',1,NULL,NULL);
...
(1,'Administrators','The main administration group, this group allows access to all areas of GKPanel.',1),
(2,'Resellers','Resellers have the ability to manage, create and maintain user accounts within GKPanel.',1),
(3,'Users','Users have basic access to GKPanel.',1);
...
(4,2,'GKPanel Config',100,'GKPanelconfig','user','Changes made here affect the entire GKPanel configuration, please double check everything before saving changes.',0,'true','',''),
(5,2,'GKPanel News',100,'news','user','Find out all the latest news and information from the GKPanel project.',0,'true','',''),
(6,2,'Updates',100,'updates','user','Check to see if there are any available updates to your version of the GKPanel software.',0,'true','',''),
(8,4,'phpMyAdmin',100,'phpmyadmin','user','phpMyAdmin is a web based tool that enables you to manage your GKPanel MySQL databases via. the web.',0,'true','',''),
...
(20,7,'Package Manager',100,'packages','user','Welcome to the Package Manager, using this module enables you to create and manage existing reseller packages on your GKPanel hosting account.',0,'true','',''),
...
(18,'news_url','GKPanel News API URL','http://api.GKPanel.org/latestnews.json',NULL,'GKPanel News URL','GKPanel Config','false'),
(19,'update_url','GKPanel Update API URL','http://api.GKPanel.org/latestversion.json',NULL,'GKPanel Update URL','GKPanel Config','false'),
...
The management',NULL,'Here you can edit the Welcme Message e-mail','GKPanel Config','true');
...
(71,'GKPanel Config','Config GKPanel'),
(72,'GKPanel News','GKPanel Aktuelles'),
...
(96,'Find out all the latest news and information from the GKPanel project.','Finden Sie heraus, alle Neuigkeiten und Informationen aus dem GKPanel Projekt.'),
(97,'Check to see if there are any available updates to your version of the GKPanel software.','Prüfen Sie, ob es irgendwelche verfügbaren Aktualisierungen für Ihre Version des GKPanel Software.'),
(98,'If you have found a bug with GKPanel you can report it here.','Did you mean: If you have found a bug with CPanel you can report it here.\r\nWenn Sie einen Fehler mit GKPanel gefunden haben, können Sie ihn hier melden.'),
(99,'phpMyAdmin is a web based tool that enables you to manage your GKPanel MySQL databases via. the web.','phpMyAdmin ist ein webbasiertes Tool, das Sie zu Ihrem GKPanel MySQL-Datenbanken via verwalten können. im Internet.'),
...
(111,'Welcome to the Package Manager, using this module enables you to create and manage existing reseller packages on your GKPanel hosting account.','Willkommen auf der Paket-Manager, mit diesem Modul ermöglicht Ihnen die Erstellung und Verwaltung von bestehenden Reseller-Pakete auf Ihrem GKPanel Hosting-Account.'),
