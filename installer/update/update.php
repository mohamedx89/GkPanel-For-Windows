...
mysql_select_db('gkpanel_hmail', $db);
...
fwrite($db_settings_file, "# Include the GKPanel managed http-vhosts file.\r\n");
...
fwrite($db_settings_file, "\$rcmail_config['db_dsnw'] = 'mysql://root:" . $password_db . "@localhost/gkpanel_roundcube';\n");
